...
def binary_constraints_update(constraints):
    ...
    if constraints == "before":
        return before
    elif constraints == "after":
        return after
    elif constraints == "starts":
        return starts
    elif constraints == "ends":
        return ends
    elif constraints == "meets":
        return meets
    elif constraints == "overlaps":
        return overlaps
    elif constraints == "during":
        return during
    elif constraints == "equals":
        return equals
