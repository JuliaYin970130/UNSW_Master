...
from searchGeneric import Searcher, AStarSearcher, BreadthFirstSearcher
from searchBranchAndBound import DF_branch_and_bound
from searchMPP import SearcherMPP

DF_branch_and_bound.max_display_level = 1
Searcher.max_display_level = 3
...
#    print("Path found:",tsearcher.search(),"  cost=",tsearcher.solution.cost)
    ...
    print("\nBreadth-first search: (Use ^C if it goes on forever)")
    tsearcher = BreadthFirstSearcher(problem)
    print("Path found:",tsearcher.search())

import searchProblem
#from searchTest import run
if __name__ == "__main__":
    run(searchProblem.romania_map,"Romania map")
