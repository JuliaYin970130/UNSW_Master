...
## articles - a
MNB_count_vec_a = CountVectorizer(lowercase=False,token_pattern='[\w#_@$%]{2,}')
...
# articles - b
MNB_count_vec_b = CountVectorizer(lowercase=True,token_pattern='[\w#_@$%]{2,}')
