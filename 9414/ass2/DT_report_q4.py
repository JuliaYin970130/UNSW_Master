...
data_train[1] = data_progressing(data_train)
data_test[1] = data_progressing(data_test)
...
## a
DT_count_vec_a = CountVectorizer(max_features=1000, lowercase=False,token_pattern='[\w#_@$%]{2,}')
...
## b
DT_count_vec_b = CountVectorizer(max_features=1000,token_pattern='[\w#_@$%]{2,}')
...
bar_width = 0.35
index = np.arange(3)
rects1 = plt.bar(index, marco_a_, bar_width, color='y', label='no conversion',alpha=0.5)
rects2 = plt.bar(index + bar_width, marco_b_, bar_width, color='g', label='with conversion', alpha=0.5)
plt.xticks(index + (bar_width/2), metrics)
plt.ylim(ymax=1)
plt.title('DT_Macro_articles')
plt.xlabel('metrics')
plt.ylabel('score')
...
bar_width = 0.35
index = np.arange(4)
rects1 = plt.bar(index, mirco_a_, bar_width, color='y', label='no conversion',alpha=0.5)
rects2 = plt.bar(index + bar_width, mirco_b_, bar_width, color='g', label='with conversion', alpha=0.5)
plt.xticks(index + (bar_width/2), metrics)
plt.ylim(ymax=1)
